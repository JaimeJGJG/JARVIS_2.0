...
class mainT(QThread):
    ...
    def JARVIS(self):
        while True:
            ...
            elif 'nome da música' in self.Input:
                resposta('Não sei')
            ...
            elif 'pare' in self.Input: #Parar reprodução
            ...
            elif 'temperatura' in self.Input:
...
class Janela (QMainWindow):
    def __init__(self):
        ...
        self.label_jarvis.setStyleSheet('QLabel {font:bold;font-size:25px;color:#2F00FF}')
